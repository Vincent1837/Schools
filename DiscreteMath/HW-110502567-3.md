...
- $Basis\ Step: {\rm max}(a, b)=\begin{cases}a \text{ , if }a\geq{b} \\ b \text{ , if }b\gt{a} \end{cases}$
  $Recursive\ Step: {\rm max}(S_n)={\rm max}(S_{n-1}, a_n)$
...
- (f) $26^6=308915776$
- (g) $26^4=456976$
#### 38 (Please check the definition of “partial function” on Wiki page.)
...
- (a) ${\rm C}^9_5\times6!=90720$
- (b) ${\rm C}^8_4\times6!=50400$
- (c) ${\rm C}^8_5\times6!\times2=80640$
...
## Section 6-3 (Starting from Page 413)
...
> **c) Of the $13$ people who showup, three are women. How many ways are there to choose $10$ players to take the field if at least one of these players must be a woman?**
- 
...
## Section 6-4 (Starting from Page 421)

> **8 . What is the coefficient of $x^8y^9$ in the expansion of$(3x + 2y)^{17}$?**
- 

> **20 . Suppose that $k$ and $n$ are integers with $1 ≤ k < n.$ Prove the hexagon identity $\big(\begin{smallmatrix} n-1 \\ k-1 \end {smallmatrix}\big) \big(\begin{smallmatrix} n \\ k+1 \end{smallmatrix}\big) \big(\begin{smallmatrix} n+1 \\ k \end{smallmatrix}\big) = \big(\begin{smallmatrix} n-1 \\ k \end{smallmatrix}\big) \big(\begin{smallmatrix} n \\ k-1\end{smallmatrix}\big) \big(\begin{smallmatrix} n+1 \\ k+1\end{smallmatrix}\big),$ which relates terms in Pascal’s triangle that form a hexagon.**
- 
> **22 . Prove the identity $\big(\begin{smallmatrix} n \\ r \end{smallmatrix}\big) \big(\begin{smallmatrix} r \\ k \end{smallmatrix}\big) = \big(\begin{smallmatrix} n \\ k \end{smallmatrix}\big) \big(\begin{smallmatrix} n-k \\ r-k \end{smallmatrix}\big)$, whenever $n$, $r$, and$k$ are nonnegative integers with $r \leq n$ and $k \leq r$,**
> **a) using a combinatorial argument.**
> **b) using an argument based on the formula for the number of $r$-combinations of a set with $n$ elements.**
- 
> **28 . Show that if $n$ is a positive integer, then $\big(\begin{smallmatrix} 2n \\ 2 \end{smallmatrix}\big) = 2\big(\begin{smallmatrix} n \\ 2 \end{smallmatrix}\big) + n^2$**
> **a) using a combinatorial argument.**
> **b) by algebraic manipulation.**
- 
> **38 . Give a combinatorial proof that if n is a positive integer then	$\sum\limits^n_{k=0}k^2 \big(\begin{smallmatrix} n \\ k \end{smallmatrix}\big) = n(n + 1)2^{n−2}$. [Hint: Show that both sides count theways to select a subset of a set of n elements together with two not necessarily distinct elements from this subset. Furthermore, express the right-hand side as $n(n − 1)2^{n−2} + n2^{n−1}$.]**
- 

## Section 6-5 (Starting from Page 432)
- 
...
> **20 . How many solutions are there to the inequality $x1 + x2 + x3 ≤ 11,$ where $x1, x2$, and $x3$ are nonnegative integers? [Hint: Introduce an auxiliary variable $x_4$ such that $x_1 + x_2 + x_3 + x_4 = 11$.]**
- 
...
- 
> **14 . Find the Canter digits $a_1, a_2,\dots ,a_{n-1}$ that correspond to these permutations.**
- 
...
> **a) $a_n = a_{n−1} + 6a_{n−2}$ for $n ≥ 2, a_0 = 3, a_1 = 6$**
> **b) $a_n = 7a_{n−1} − 10a_{n−2}$ for $n ≥ 2, a_0 = 2, a_1 = 1$**
> **c) $a_n = 6a_{n−1} − 8a_{n−2}$ for $n ≥ 2, a_0 = 4, a_1 = 10$**
> **d) $a_n = 2a_{n−1} − a_{n−2}$ for $n ≥ 2, a_0 = 4, a_1 = 1$**
> **e) $a_n = a_{n−2}$ for $n ≥ 2, a_0 = 5, a_1 = −1$**
> **f) $a_n = −6a_{n−1} − 9a_{n−2}$ for $n ≥ 2, a_0 = 3, a_1 = −3$**
> **g) $a_{n+2} = −4a_{n+1} + 5a_n$ for $n ≥ 0, a_0 = 2, a_1 = 8$**
- 
...
- 
> **30 .**
> **a) Find all solutions of the recurrence relation $a_n = −5a_{n−1} − 6a_{n−2} + 42 · 4^n.$**
