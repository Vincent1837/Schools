...
- 
> **32 . How many different functions are there from a set with 10 elements to sets with the following numbers of elements?**
> **a) 2** 
> **b) 3** 
> **c) 4** 
> **d) 5**
...
> **20 . How many solutions are there to the inequality $x1 + x2 + x3 ≤ 11,$ where $x1, x2$, and $x3$ are nonnegative integers? [Hint: Introduce an auxiliary variable $x_4$ such that $x_1 + x_2 + x_3 +
x_4 = 11$.]**
- 
