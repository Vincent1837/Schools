...
.data
target1 BYTE "110502531",0 ; fill the studend ID of team member 1
target2 BYTE "110502567",0 ; fill the studend ID of team member 2
target3 BYTE "999999999",0

.code
main PROC

INVOKE Str_remove, OFFSET target1, 5 ; Remove five char
