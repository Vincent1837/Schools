...
.model flat,stdcall
.stack 4096
ExitProcess proto,dwExitCode:dword	;delcare proto type
DifferentInputs proto, v1:dword, v2:dword, v3:dword	;delcare proto type
main     EQU start@0
.data
.code
main proc
    ...
    invoke DifferentInputs, 104522064, 110502531, 110502567 ;fill your IDs
